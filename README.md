...
1. Low-level SPI protocol implementation (Bit-banging):
  - Hex commands were taken directly from the datasheet and transmitted them through simple bit-banging.
...
4. Benchmarking, comparison to hardware SPI
  ...
  - According to the benchmarks:
    ...
    | Hardware SPI (`SPI.h`) | 1024-byte contiguous bulk push | 750 - 850 FPS |
